...
def parse_arguments():
    ...
    parser.add_argument('--epochs', default=25, help='Number of epochs to train the model for', type=int)
    ...
    parser.add_argument('--save_interval', default=1, help='Number of epochs after which to save the weights. If None, does not save', type=int)
