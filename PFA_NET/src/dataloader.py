...
class SODLoader(Dataset):
    ...
    def __init__(self, mode='train', augment_data=False, target_size=256):
        if mode == 'train':
            self.inp_path = 'C:/Users/pushp/PFA NET/data/DUTS/DUTS-TR/DUTS-TR-Image'
            self.out_path = 'C:/Users/pushp/PFA NET/data/DUTS/DUTS-TR/DUTS-TR-Mask'
        elif mode == 'test':
            self.inp_path = 'C:/Users/pushp/PFA NET/data/DUTS/DUTS-TE/DUTS-TE-Image'
            self.out_path = 'C:/Users/pushp/PFA NET/data/DUTS/DUTS-TE/DUTS-TE-Mask'
        else:
...
if __name__ == '__main__':
    ...
    inp_img = cv2.imread('C:/Users/pushp/PFA NET/data/DUTS/DUTS-TE/DUTS-TE-Image/COCO_val2014_000000000192.jpg')
    out_img = cv2.imread('C:/Users/pushp/PFA NET/data/DUTS/DUTS-TE/DUTS-TE-Mask/COCO_val2014_000000000192.png', -1)
    # inp_img = inp_img.astype('float32')
