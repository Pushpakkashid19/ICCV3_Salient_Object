...
def parse_arguments():
    ...
    parser.add_argument('--imgs_folder', default='C:/Users/pushp/PFA NET/data/DUTS/DUTS-TE/DUTS-TE-Image', help='Path to folder containing images', type=str)
    parser.add_argument('--model_path', default='C:/Users/pushp/PFA NET/models/alph-0.7_wbce_w0-1.0_w1-1.15/weights/best-model_epoch-010_mae-0.1367_loss-0.2880.pth', help='Path to model', type=str)
